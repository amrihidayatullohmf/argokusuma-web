...
$base_url="http://local.mobileforce.co"; //url base of site if you want only relative url leave empty
$upload_dir = '/ggmild/uploads/content'; // path from base_url to upload base dir
$current_path = '../../../../../uploads/content/'; // relative path from filemanager folder to upload files folder
